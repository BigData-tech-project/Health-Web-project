        ...
        <table>
            ...
            <tbody>
                <c:forEach var="data" items="${dataList}">
                    <tr>
                        <td><c:out value="${data.dateCreated}" /></td> <!-- 날짜 필드명 수정 -->
                        <td><c:out value="${data.maxpressure}" /></td> <!-- 필드명 수정 -->
                        <td><c:out value="${data.minpressure}" /></td> <!-- 필드명 수정 -->
                        <td><c:out value="${data.rate}" /></td>
                        <td><c:out value="${data.temp}" /></td> <!-- 필드명 수정 -->
                        <td><c:out value="${data.sugar}" /></td> <!-- 필드명 수정 -->
