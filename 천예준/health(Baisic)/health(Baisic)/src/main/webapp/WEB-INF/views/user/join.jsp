            ...
            <div class="container">
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        <form action="/health/user/login" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <!-- id input-->
                            ...
                            <!-- Submit Button-->
                            <button class="btn btn-primary btn-xl" id="join" type="submit" >회원가입</button>
                        </form>
                    </div>
                </div>
            </div>
