...
<body>
    <!-- 제목 추가 -->
    <div class="title">체온 유형</div>

    <div class="container">
        <!-- 고체온 박스 - 클릭 시 high_temperature.jsp로 이동 -->
        <a href="high_temperature" class="box box-high">
            <div class="icon">🌡️</div> <!-- 고체온 이모티콘 -->
            고체온
        </a>

        <!-- 저체온 박스 - 클릭 시 low_temperature.jsp로 이동 (예시) -->
        <a href="low_temperature" class="box box-low">
            <div class="icon">❄️</div> <!-- 저체온 이모티콘 -->
            저체온
        </a>
    </div>
